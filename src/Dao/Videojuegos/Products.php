...
class products extends Table
{
    public static function getProducts(
        ...
        // IMPORTANTE: Para que PDO maneje LIMIT con parámetros, debes usar bindValue con tipo entero en el método execute.
        // Si tu método obtenerRegistros no lo hace, deberás adaptar ahí o construir la consulta con intval() directo.
